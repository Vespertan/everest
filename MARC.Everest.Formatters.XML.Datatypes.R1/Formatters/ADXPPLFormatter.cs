...
namespace MARC.Everest.Formatters.XML.Datatypes.R1.Formatters
{
    ...
    public class ADXPPLFormatter : ANYFormatter, IDatatypeFormatter
    {
        ...
        public override void Graph(System.Xml.XmlWriter s, object o, DatatypeFormatterGraphResult result)
        {
            ...
            if (instance.PostCity != null)
            {
                s.WriteAttributeString("type", "http://www.w3.org/2001/XMLSchema-instance", "extPL:adxp.postalCode");
                s.WriteAttributeString("postCity", instance.PostCity);
            }
